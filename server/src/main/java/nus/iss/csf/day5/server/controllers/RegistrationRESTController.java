package nus.iss.csf.day5.server.controllers;
...
import nus.iss.csf.day5.server.models.Registration;
import nus.iss.csf.day5.server.models.Response;
...
public class RegistrationRESTController {
    ...
    public ResponseEntity<String> Registration(@RequestBody String payload) {
        ...
        // Read the payload and save the data to the database
        ...
        // Save to database
        // return ResponseEntity.status(HttpStatus.CREATED).body( "{}"); //dont put body here
